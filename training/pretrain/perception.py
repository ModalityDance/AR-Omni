...
class PerceptionLoss(nn.Module):
    ...
    Notes:
        ...
        - `input_ids - 4` is kept as-is to match the original training token mapping.
    """
    ...
    def forward(self, input_ids: torch.Tensor, generated_hidden_states: torch.Tensor) -> torch.Tensor:
        # Keep original hard constraint for sequence length.
        ...
        # Keep the original token id offset.
